    ...
    <div className="relative w-full min-h-screen overflow-x-hidden">
      ...
      <div className="relative w-full h-[80vh] lg:h-[120vh]">
        ...
        <div className="absolute top-[5.2em] left-10 z-20 pr-[2em]">
          ...
          <div className="h-1 bg-blue-300 my-2" />
          <p className="text-white mt-4">
            *Earn potential annual interest in the 70–90% range
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center px-4 my-10">
        ...
        <p className="text-blue-500 mt-8">Private Placement Bond Offering</p>
            ...
            <div className="w-full max-w-7xl mx-auto mt-10 px-4 md:px-20">
              <div className="flex items-center gap-6">
                ...
                <button
                  ...
                  disabled={index === 0}
                  className="hidden md:flex bg-white p-3 rounded-full shadow disabled:opacity-40"
                >
                  <ChevronLeft />
                </button>
                ...
                <div className="w-full overflow-hidden rounded-2xl">
                  ...
                  >
                    {investments.map((item) => (
                      ...
                      >
                        <div className="max-w-[23.5em] mx-auto bg-linear-to-r from-[#041a35] to-[#2a5f9b] text-white rounded-2xl overflow-hidden shadow-lg cursor-pointer hover:scale-105 transition-transform">
