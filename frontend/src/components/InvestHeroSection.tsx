...
const InvestHeroSection: React.FC = () => {
  ...
  return (
    <div  className="relative w-full h-[45em] flex items-center justify-center overflow-hidden" data-aos="fade-up">
      <img
      ...
      <div className='flex flex-col relative z-30 text-start text-white items-start px-[2em] mt-[10em] lg:mt-[10em] w-full gap-[2em]' data-aos="fade-up">
