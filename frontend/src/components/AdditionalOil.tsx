...
const AdditionalOil: React.FC<AdditionalOilProps> = ({ scrollToForm }) => {
  return (
    <div className='flex flex-col bg-[#041a35] px-[2em] lg:px-[4em] mb-[5em] pb-[6em] pt-[6em]'>
      <p className='flex self-center text-[2em] lg:text-5xl text-white mb-[0.4em]'>Additional Oil Investment Benefits</p>
      <p className='flex self-center text-[1em] lg:text-[1.2em] font-serif text-white'>Read below for additional oil and gas well ownership benefits</p>
      <div className="relative z-20 flex flex-col lg:flex-row gap-[3em] lg:gap-[2em] mt-[4em]">

        {/* BLOCK 1 */}
        <div className="flex gap-[1.5em]">
          <div className="flex items-start">
            {/* Vertical line container that expands with content */}
            <div className="relative h-full min-h-full flex">
              <div className="h-full min-h-[6em] lg:min-h-[8em] bg-white w-[0.05em] mt-0.5" />
            </div>
          </div>
